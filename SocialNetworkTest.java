...
public class SocialNetworkTest {
    ...
    private static final Tweet tweet1 = new Tweet(1, "Aena", "is it reasonable to talk  ", d1);
    private static final Tweet tweet2 = new Tweet(2, "BananaCupcake", "can we please pass this test??#hype", d2);
    private static final Tweet tweet3 = new Tweet(3, "Hiba", "can we please pass this test??", d3);
    private static final Tweet tweet4 = new Tweet(4, "Imama", "@user1 is this another one of these stupid tests?",
            d4);
    private static final Tweet tweet5 = new Tweet(5, "hiraa", "@user1 @user2 Hello world",
            d5);
    private static final Tweet tweet6 = new Tweet(6, "hala", "@user1 @user3 I'm doing another test ",
            d6);
    ...
    public void testGuessFollowsGraphUsernameDifferentCases(){
        ...
        assertTrue(followsGraph.get("user2").contains("user1"));
    }
    ...
    public void testInfluencersSixTweets(){
        ...
        List<String> influencers= SocialNetwork.influencers(followsGraph);
        assertEquals(influencers.get(0),"user1");
